...
export default function FooterFields() {
  return (
    <>
      ...
      <div className="row">
        <div className="col-3"><textarea className="form-control mt-0" rows="8" placeholder="Enter marks information" style={{ resize: 'none' }} /></div>
        <div className="col-2"><textarea className="form-control mt-0" rows="1" placeholder="Enter total packages" style={{ resize: 'none' }} /></div>
        <div className="col-5"><textarea className="form-control mt-0" rows="8" placeholder="Enter description of packages and goods" style={{ resize: 'none' }} /></div>
      </div>
    </>
  );
}