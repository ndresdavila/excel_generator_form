    ...
    <div className="row mt-4">
      <div className="col-6">
        ...
        <div className="row g-0 mt-0">
          ...
          <div className="col-9">
            <input type="text" className="form-control mt-0" name="consigneeContact" placeholder="Enter contact info" />
          </div>
        </div>
        <div className="row g-0 mt-4">
          ...
          <div className="col-9">
            <input type="text" className="form-control mt-0" name="notifyContact" placeholder="Enter contact info" />
          </div>
        </div>
      </div>
    </div>
