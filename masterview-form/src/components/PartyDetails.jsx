  ...
  return (
    <div className="row mt-4">
      <div className="col-6">
        ...
        <textarea id="consignee" className="form-control mt-0" name="consignee" rows="8" placeholder="CONSIGNEE: Name and Full Address / Non-Negotiable Unless Consigned to Order" style={{ resize: 'none' }} />
        ...
        <div className="row g-0 mt-4">
          <div className="col-12">
            ...
            <textarea id="notify" className="form-control mt-0" name="notifyParty" rows="8" placeholder="NOTIFY PARTY: Name and full address" style={{ resize: 'none' }} />
          </div>
          <div className="col-3">
            <label className="form-label fw-bold border p-2 d-block bg-light text-dark text-start mb-0">Contact</label>
          </div>
